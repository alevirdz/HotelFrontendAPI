    ...
    <v-row class="text-center">
      ...
      <v-col class="mb-4">
        ...
        <p class="subheading font-weight-regular">
          ...
          <a class="link" href="https://community.vuetifyjs.com" target="_blank">Discord Community</a>
        </p>
      </v-col>
      ...
      <v-col class="mb-5" cols="12">
        ...
        <v-row justify="center">
          <a v-for="(next, i) in whatsNext" :key="i" :href="next.href" class="subheading mx-3 link" target="_blank">
            {{ next.text }}
          </a>
        </v-row>
      </v-col>
